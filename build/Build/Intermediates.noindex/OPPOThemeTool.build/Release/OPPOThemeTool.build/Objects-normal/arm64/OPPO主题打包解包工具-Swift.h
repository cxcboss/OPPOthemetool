...
#ifndef OPPO主题打包解包工具_SWIFT_H
#define OPPO主题打包解包工具_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OPPO主题打包解包工具",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC28OPPO主题打包解包工具13DroppableView")
